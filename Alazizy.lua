...
ControllerAll = false
local ListSudos ={Sudo_Id,1304011680,5073100917,1183747742,1486568463,1343405656}  
...
Status = 'ست البنات'
elseif tonumber(UserId) == 1343405656 then
Status = 'مالك السورس'
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1343405656 then
