...
Redis:set(Alazizy..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
if text and Redis:get(Alazizy..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(Alazizy..msg.chat_id.."name_mean"..msg.sender.user_id)
name_api = https.request("https://timoa.ml/API/mean.php?name="..URL.escape(text).."")
local api_decode = JSON.decode(name_api)
local name_mean = api_decode['mean']
local photo_mean = api_decode['photo']
local rep = msg.id/2097152/0.5
  https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg_chat_id.."&caption="..URL.escape(name).."&photo="..photo_mean.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
