...
--download('https://raw.githubusercontent.com/moazizaa/MOSTAFA/master/Alazizy.lua','Alazizy.lua')
...
data = {
{
{text = '⦁ 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥??𝐳𝐢𝐳a ⦁', url = 't.me/BANDA1M'}, 
},
}
}
