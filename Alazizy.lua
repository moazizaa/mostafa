...
ControllerAll = false
local ListSudos ={Sudo_Id,1304011680,5073100917,1183747742,1486568463,1645029916}  
...
elseif tonumber(UserId) == 5073100917 then
Status = 'مبرمج السورس'
elseif tonumber(UserId) == 1304011680  then
Status = 'بسام نيوتلا'
elseif tonumber(UserId) == 1645029916 then
Status = 'مالك السورس'
elseif tonumber(UserId) == 1486568463 then
Status = 'ندي احمد'
...
Distinguished = Redis:sismember(Alazizy.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 1304011680 then
Status = true
elseif tonumber(UserId) == 1486568463 then
Status = true
elseif tonumber(UserId) == 1645029916 then
...
elseif tonumber(msg.sender.user_id) == 1486568463 then
msg.Name_Controller = 'ندي احمد '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5073100917 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1645029916 then
msg.Name_Controller = 'مالك السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1304011680 then
msg.Name_Controller = 'بسام نيوتلا'
msg.The_Controller = 1
...
if UserId == "1304011680" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⋆ عذرآ لا تستطيع استخدام الامر على بسام نيوتلا*","md",true)  
end
if UserId == "1183747742" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⋆ عذرآ لا تستطيع استخدام الامر على مبرمج السورس *","md",true)  
end
if UserId == "5073100917" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⋆ عذرآ لا تستطيع استخدام الامر على مبرمج السورس *","md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = '⋆ ᵈᵉᵛ ᵃˡᵃᶻᶤᶻʸ •', url = "https://t.me/php_7"},{text = '⋆ ᵇᵒᵗ ᵇᵃᶰᵈᵃ •', url = "https://t.me/B64Bbot"},
},
{
...
if text == 'المبرمج عزايزي' or text == 'عزازي' or text == 'المبرمج' or text == 'العزايزي' then  
