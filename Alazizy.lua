...
sec = time.sec
local_time = hour..":"..min
list = Redis:smembers(Alazizy.."ChekBotAdd")
--> by @AanUubiS <--
if local_time then
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ متبقاش تقطع الجوبات..😂💘',"md",true)  
end
if text == 'باي' or text == 'بيي' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ باي ياحته مني..🥺💘',"md",true)  
end
if text == 'عامل اي' or text == 'اي عامل' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عامل جمعيه..🙄💘',"md",true)  
end
if text == 'تيب' or text == 'طيب' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'فرح خالتك قريب..😂♥️',"md",true)  
end
...
if text == 'هلا' or text == 'هاي' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ هلا بيك ياروحي..💛',"md",true)  
end
if text == 'تمام' or text == 'بخير' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ دايما ياحبيبي..🌚💜',"md",true)  
end
if text == 'الحمدلله' or text == 'ويوبن' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تستاهل الحمد يرحي..🙈♥️',"md",true)  
end
if text == 'حصل' or text == 'حثل' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ محصلش بطل تطبيل..🙄💘',"md",true)  
end
if text == 'حبق' or text == 'بحبك' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بعشء امك..🥺💘',"md",true)  
end
if text == '🙄🙄' or text == '🙄🙄🙄' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ سقف الجروب عاجبك..😂💜',"md",true)  
end
if text == '😒😒' or text == '😒😒😒' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ افرد وشك المعفن ده..😑💔',"md",true)  
end
if text == 'دي' or text == 'ده' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ لا مش هي دي..😹🔥',"md",true)  
end
if text == '.' or text == '..' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بتنقط لي ياحزين..🙂💔',"md",true)  
end
if text == 'عامل اي' or text == 'اي عامل' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ خدوني تيب..😪💔',"md",true)  
end
if text == 'بكرهك' or text == 'كرهتك' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ونا والله مش طايقك..😒💔',"md",true)  
end
if text == '😂😂' or text == '😂😂😂' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ دامت ضحكتك يابيبي..🥺💘',"md",true)  
end
if text == 'اخرص' or text == 'اخرصي' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ هات لازقه احطها ع بوئي..😹♥️',"md",true)  
end
if text == 'فين الادمن' or text == 'الادمن فين' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ فلخاص بيخصخص..😂💘',"md",true)  
end
if text == 'بتحبك' or text == 'بتحبني' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بدمنك ياحبيبي..🥺♥️',"md",true)  
end
...
if text == 'خلاص' or text == 'خلصانه' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ خلصت روحك يابعيد..😹💔',"md",true)  
end
if text == 'فل' or text == 'فلل' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ فل علكل يصحاب..🙄💘',"md",true)  
end
if text == 'مين' or text == 'انت مين' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ انا بوت وبحبك..🥺💘',"md",true)  
end
if text == 'البوت واقف' or text == 'وقف' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ لا انا شغال متحورش..😒💔',"md",true)  
end
if text == 'فين' or text == 'انت فين' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ هنا فقلبي..😹♥️',"md",true)  
end
if text == 'اوف' or text == 'يوه' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ يتي القمر زعلان من اي..🥺🔥',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بالتكت بتعها..🙄💔',"md",true)  
end
if text == 'بعشقك' or text == 'بموت فيك' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بدمنك ياعيوني..🥺💘',"md",true)  
end
if text == 'عيب' or text == 'لا عيب' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ سيب الواد يلعب..🙄💛',"md",true)  
end
if text == 'هه' or text == 'هههه' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ضحكه مش سالكه زيك..😹💘',"md",true)  
end
if text == 'تؤ' or text == 'تؤ تؤ' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ يانوحي يانوحي..🥺💘',"md",true)  
end
if text == 'حلو' or text == 'حلوه' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'يحلات عيونك..♥️🦋',"md",true)  
end
if text == 'بتعمل اي' or text == 'عملت اي' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ونت مالك ياحشري..🙄💘',"md",true)  
end
if text == '😹😹😹' or text == '😹😹😹' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ بتضحك علي خيبتك..🙄💘',"md",true)  
end
if text == 'جيت' or text == 'انا جيت' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ نورت يارئيس اركان قلبي..🥺💘',"md",true)  
end
if text == 'النبي' or text == 'صلي علي النبي' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عليه افضل الصلاه والسلام..♥️🌍',"md",true)  
end
if text == 'نعم' or text == 'يانعم' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ مين مؤدب ناوو..😹💘',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ محات كتير يرحي..🙈💋',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ انت الخير يعمري..😌💞',"md",true)  
end
if text == 'صباح النور' or text == 'باح الخير' then
if not Redis:get(Alazizy.."rb:bna"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ صباح العسل..✋♥️😁',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ كفيه شقط سيب حاجه لغيرك..♥️😂',"md",true)  
end
...
if text == "جوزوني" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if text == "اسم الجروب" or text == "رابط الجروب" then
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
https.request("http://api.fr-ee.online/Send/scource.php?token="..Token.."&chat="..ChatId.."&url="..mp3.."&type=mp3")
elseif Text and Text:match("ogg/(.*)") then
local ogg = Text:match("ogg/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("http://api.fr-ee.online/Send/scource.php?token="..Token.."&chat="..ChatId.."&url="..ogg.."&type=ogg")
elseif Text and Text:match("mp4/(.*)") then
local mp4 = Text:match("mp4/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("http://api.fr-ee.online/Send/scource.php?token="..Token.."&chat="..ChatId.."&url="..mp4.."&type=mp4")
end
...
elseif text == 'هنتهتنهمتهنخع' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
if ChannelJoin(msg) == false then
