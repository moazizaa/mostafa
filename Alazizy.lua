...
keyboard = {} 
keyboard.inline_keyboard = {{{text="◗الرابط نص◖",callback_data="/LinkText:"..msg.sender_user_id_},{text="◗الرابط انلاين◖",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="◗اخفاء الامر◖",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖??𝙖𝙯𝙞𝙯𝙮 ◖',url="t.me/BANDA1M"}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Link or Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
