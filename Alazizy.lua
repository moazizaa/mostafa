...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Alazizy,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,1183747742,5030447863,1709783101}  
...
Status = 0
DevelopersQ = Redis:sismember(Alazizy.."Alazizy:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(Alazizy.."Alazizy:Developers:Groups",UserId) 
TheBasics = Redis:sismember(Alazizy.."Alazizy:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Alazizy.."Alazizy:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Alazizy.."Alazizy:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Alazizy.."Alazizy:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Alazizy.."Alazizy:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Alazizy.."Alazizy:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1183747742 then
Status = 'مصطفي العزايزي'
elseif UserId == 5030447863 then  
Status = 'حسني الفنان'
elseif UserId == 1709783101 then  
Status = 'ست البنات'
...
Status = Redis:get(Alazizy.."Alazizy:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(Alazizy.."Alazizy:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Alazizy.."Alazizy:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Alazizy.."Alazizy:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Alazizy.."Alazizy:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Alazizy.."Alazizy:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Alazizy.."Alazizy:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Alazizy.."Alazizy:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Alazizy.."Alazizy:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Alazizy.."Alazizy:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(Alazizy.."Alazizy:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(Alazizy.."Alazizy:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(Alazizy.."Alazizy:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(Alazizy.."Alazizy:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(Alazizy.."Alazizy:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(Alazizy.."Alazizy:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Alazizy.."Alazizy:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(Alazizy.."Alazizy:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(Alazizy.."Alazizy:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(Alazizy.."Alazizy:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Alazizy.."Alazizy:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(Alazizy.."Alazizy:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(Alazizy.."Alazizy:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Alazizy.."Alazizy:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(Alazizy.."Alazizy:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(Alazizy.."Alazizy:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(Alazizy.."Alazizy:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Alazizy.."Alazizy:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(Alazizy.."Alazizy:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
BanAll = Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..ChatId,UserId)
}
end
...
JoinChannel = true
local chh = Redis:get(Alazizy.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(Alazizy.."Lock:channell"..msg_chat_id) then
print(Redis:get(Alazizy.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(Alazizy.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(Alazizy..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
msg.Name_Controller = 'مصطفي العزايزي'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5030447863 then
msg.Name_Controller = 'حسني الفنان'
msg.The_Controller = 1
...
elseif Redis:sismember(Alazizy.."Alazizy:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Alazizy.."Alazizy:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Alazizy.."Alazizy:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Alazizy.."Alazizy:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Alazizy.."Alazizy:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Alazizy.."Alazizy:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Alazizy.."Alazizy:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Alazizy.."Alazizy:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Alazizy) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Alazizy.."Alazizy:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Alazizy.."Alazizy:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Alazizy.."Alazizy:Status:Welcome"..msg_chat_id) then
local ban = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Alazizy.."Alazizy:Welcome:Group"..msg_chat_id)
if Welcome then 
if ban.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Alazizy) then
return false
end
local floods = Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Alazizy.."Alazizy:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Alazizy.."Alazizy:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Alazizy.."Alazizy:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Alazizy.."Alazizy:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Alazizy.."Alazizy:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Alazizy.."Alazizy:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Alazizy.."Alazizy:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Alazizy.."Alazizy:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Alazizy.."Alazizy:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get
Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Alazizy..'Alazizy:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(Alazizy.."Alazizy:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Alazizy.."Alazizy:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Alazizy.."Alazizy:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Alazizy.."Alazizy:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Alazizy.."Alazizy:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Alazizy.."Alazizy:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Alazizy.."Alazizy:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(Alazizy.."Alazizy:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Alazizy.."Alazizy:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Alazizy.."Alazizy:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Alazizy.."Alazizy:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Alazizy.."Alazizy:Set:On"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Gif"..text..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Vico"..text..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Stekrs"..text..msg_chat_id)     
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Text"..text..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Photo"..text..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Video"..text..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:File"..text..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Audio"..text..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:video_note"..text..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Set:Sudo:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Alazizy.."Alazizy:List:Rd:Sudo"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"*⦁ تم حذف الرد في قائمه الردود العامه *","md",true)  
return false
end
end
if Redis:get(Alazizy.."Alazizy:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '⋆ الغاء الامر •' then   
Redis:del(Alazizy.."Alazizy:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⦁ تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(Alazizy.."Alazizy:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Alazizy.."Alazizy:PinMsegees:"..v,text)
end
end
...
local list = Redis:smembers(Alazizy.."Alazizy:Num:User:Pv") 
...
if text and Redis:get(Alazizy..'Alazizy:GetTexting:DevAlazizy'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '⋆ الغاء الامر •' then 
Redis:del(Alazizy..'Alazizy:GetTexting:DevAlazizy'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ تم الغاء حفظ كليشة المطور')
end
Redis:set(Alazizy..'Alazizy:Texting:DevAlazizy',text)
Redis:del(Alazizy..'Alazizy:GetTexting:DevAlazizy'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ تم حفظ كليشة المطور')
end
if Redis:get(Alazizy.."Alazizy:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⦁ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Alazizy.."Alazizy:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Alazizy.."Alazizy:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Alazizy.."Alazizy:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⦁ تم تعين الايدي عام',"md",true)  
end
if Redis:get(Alazizy.."Alazizy:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⦁ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Alazizy.."Alazizy:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Alazizy.."Alazizy:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Alazizy.."Alazizy:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⦁ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Alazizy.."Alazizy:Change:Alazizy:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '⋆ الغاء الامر •' then   
Redis:del(Alazizy.."Alazizy:Change:Alazizy:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⦁ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Alazizy.."Alazizy:Change:Alazizy:Name:Bot"..msg.sender.user_id) 
Redis:set(Alazizy.."Alazizy:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⦁ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Alazizy.."Alazizy:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '⋆ الغاء الامر •' then   
Redis:del(Alazizy.."Alazizy:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⦁ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Alazizy.."Alazizy:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Alazizy.."Alazizy:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⦁ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Alazizy.."Alazizy:Game:Smile"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Smile"..msg.chat_id) then
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Alazizy.."Alazizy:Game:Smile"..msg.chat_id)
...
if Redis:get(Alazizy.."Alazizy:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Monotonous"..msg.chat_id) then
Redis:del(Alazizy.."Alazizy:Game:Monotonous"..msg.chat_id)
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Alazizy.."Alazizy:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Riddles"..msg.chat_id) then
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Alazizy.."Alazizy:Game:Riddles"..msg.chat_id)
...
if Redis:get(Alazizy.."Alazizy:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Alazizy.."Alazizy:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Alazizy.."Alazizy:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Reflection"..msg.chat_id) then
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Alazizy.."Alazizy:Game:Reflection"..msg.chat_id)
...
if Redis:get(Alazizy.."Alazizy:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Alazizy.."Alazizy:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Alazizy.."Alazizy:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Alazizy.."Alazizy:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Alazizy.."Alazizy:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Alazizy.."Alazizy:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Alazizy.."Alazizy:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Alazizy.."Alazizy:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Alazizy.."Alazizy:Game:Difference"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Difference"..msg.chat_id) then 
Redis:del(Alazizy.."Alazizy:Game:Difference"..msg.chat_id)
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Alazizy.."Alazizy:Game:Example"..msg.chat_id) then
if text == Redis:get(Alazizy.."Alazizy:Game:Example"..msg.chat_id) then 
Redis:del(Alazizy.."Alazizy:Game:Example"..msg.chat_id)
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Alazizy.."Alazizy:All:Get:Reides:Commands:Group"..text) or Redis:get(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Alazizy.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Alazizy.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Alazizy.."chfalse")
Redis:set(Alazizy.."chfalse",ch)
Redis:del(Alazizy.."ch:admin")
Redis:set(Alazizy.."ch:admin",data.result.invite_link)
else
...
Redis:set(Alazizy.."ch:addd"..msg.sender.user_id,"on")
...
Y = Y + 1
Redis:sadd(Alazizy..'Alazizy:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Alazizy.."Alazizy:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Alazizy.."Alazizy:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Alazizy.."Alazizy:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Alazizy.."Alazizy:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Alazizy.."Alazizy:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Alazizy.."Alazizy:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(Alazizy.."Alazizy:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Alazizy.."Alazizy:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Alazizy.."Alazizy:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Alazizy.."Alazizy:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Alazizy.."Alazizy:TheBasics:Group"..idg,idASAS)
end;end
end
...
--download('https://raw.githubusercontent.com/JABWA-Alazizy/MOSTAFA/master/Alazizy.lua','Alazizy.lua')
...
Redis:del(Alazizy.."Alazizy:SendBcBot") 
...
Redis:set(Alazizy.."Alazizy:SendBcBot",true) 
...
Redis:del(Alazizy.."Alazizy:LeftBot") 
...
Redis:set(Alazizy.."Alazizy:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Alazizy.."Alazizy:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '⋆ الغاء الامر •' then   
Redis:del(Alazizy.."Alazizy:AddSudosNew"..msg_chat_id)
...
Redis:set(Alazizy.."Alazizy:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Alazizy..'Alazizy:ChekBotAdd')  
local UsersBot = Redis:smembers(Alazizy..'Alazizy:Num:User:Pv')  
...
local President = Redis:smembers(Alazizy.."Alazizy:TheBasics:Group"..v)
local Constructor = Redis:smembers(Alazizy.."Alazizy:Originators:Group"..v)
local Manager = Redis:smembers(Alazizy.."Alazizy:Managers:Group"..v)
local Admin = Redis:smembers(Alazizy.."Alazizy:Addictive:Group"..v)
local Vips = Redis:smembers(Alazizy.."Alazizy:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Alazizy..'Alazizy:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local UserInfo = LuaTele.getUser(Alazizy)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "القمه")
Groups = (Redis:scard(Alazizy..'Alazizy:ChekBotAdd') or 0)
Users = (Redis:scard(Alazizy..'Alazizy:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/BANDA1M'}, 
},
{
{text = Grosupsw, url = 't.me/BANDA1M'}, 
},
{
{text = Usperos, url = 't.me/BANDA1M'}, 
},
}
...
if Redis:sismember(Alazizy.."Alazizy:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Alazizy..'Alazizy:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Alazizy..'Alazizy:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Alazizy.."Alazizy:ChekBotAdd",msg_chat_id)
Redis:set(Alazizy.."Alazizy:Status:Id"..msg_chat_id,true) ;Redis:set(Alazizy.."Alazizy:Status:Reply"..msg_chat_id,true) ;Redis:set(Alazizy.."Alazizy:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Alazizy.."Alazizy:Status:BanId"..msg_chat_id,true) ;Redis:set(Alazizy.."Alazizy:Status:SetId"..msg_chat_id,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Alazizy.."Alazizy:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Alazizy.."Alazizy:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n*
md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Alazizy.."Alazizy:Status:Welcome"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:Id"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:Reply"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:BanId"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*⦁ تم تعطيل الرفع *","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Alazizy.."Alazizy:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*⦁ تم تعطيل الالعاب *","md",true)
end
if TextMsg == 'التحقق' then
Redis:del(Alazizy.."Alazizy:Status:joinet"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*⦁ تم تعطيل التحقق *","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Alazizy.."Alazizy:Status:KickMe"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ تم تعطيل امر رددد ","md",true)
end
if TextMsg == 'جمالي' then
...
if TextMsg == 'ردود السورس' then
Redis:del(Alazizy.."Alazizy:Sasa:MOSTAFA"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*⦁ تم تعطيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:del(Alazizy.."Alazizy:Status:remMe"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:BotFree") 
...
Redis:del(Alazizy.."Alazizy:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'ست البنات' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⦁ عذرا لا تستطيع حظر عام⋆ "..Controller(msg_chat_id,UserId_Info.id).." •*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'مصطفي العزايزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⦁ عذرا لا تستطيع حظر عام⋆ "..Controller(msg_chat_id,UserId_Info.id).." •*","md",true)  
end
if Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Alazizy.."Alazizy:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Alazizy.."Alazizy:ktmAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uu_Alazizy'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
...
if not msg.Originators and not Redis:get(Alazizy.."Alazizy:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'ست البنات' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⦁ عذرا لا تستطيع حظر عام⋆ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." •*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مصطفي العزايزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⦁ عذرا لا تستطيع حظر عام⋆ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." •*","md",true)  
end
if Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy.."Alazizy:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Alazizy.."Alazizy:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy.."Alazizy:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Alazizy.."Alazizy:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,UserId) == 'ست البنات' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⦁ عذرا لا تستطيع حظر عام⋆ "..Controller(msg_chat_id,UserId).." •*","md",true)  
end
if Redis:sismember(Alazizy.."Alazizy:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:BanAll:Groups",UserId) 
...
if Controller(msg_chat_id,UserId) == 'مصطفي العزايزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع كتم عام⋆ "..Controller(msg_chat_id,UserId).." •*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'ست البنات' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع كتم عام⋆ "..Controller(msg_chat_id,UserId).." •*","md",true)  
end
if Redis:sismember(Alazizy.."Alazizy:ktmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:ktmAll:Groups",UserId) 
...
if Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Alazizy.."Alazizy:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Alazizy.."Alazizy:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Alazizy.."Alazizy:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Alazizy.."Alazizy:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Alazizy.."Alazizy:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Alazizy.."Alazizy:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Alazizy.."Alazizy:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Alazizy.."Alazizy:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Alazizy.."Alazizy:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(Alazizy.."Alazizy:Status:KickMe"..msg_chat_id) then
...
if ban.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @BANDA1M"..Creator.."\n"
else
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Alazizy.."Alazizy:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local T = '*• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  ⋆ *['..ban.first_name..'](tg://user?id='..ban.id..')**'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local zwgat_list = Redis:smembers(Alazizy..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(Alazizy..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(Alazizy..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(Alazizy..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Alazizy.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⦁ هاذا الامر يخص「 '..Controller_Num(7)..' 」* ',"md",true)  
end
Redis:set(Alazizy.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(Alazizy.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(Alazizy.."Alazizy:Lock:text"..msg_chat_id,true) 
...
Redis:set(Alazizy.."Alazizy:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set
:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Alazizy.."Alazizy:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Alazizy.."Alazizy:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Alazizy.."Alazizy:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Alazizy.."Alazizy:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Alazizy.."Alazizy:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = 'تعطيل ردود السورس', data = IdUser..'/'.. 'mostaf_sasa'},{text = 'تفعيل ردود السورس', data = IdUser..'/'.. 'MOSTAFA_alone'},
},
{
...
if Redis:get(Alazizy.."Alazizy:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(Alazizy.."Alazizy:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '• ??𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a ⋆', url = 't.me/BANDA1M'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Alazizy.."Alazizy:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Alazizy.."Alazizy:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Alazizy.."Alazizy:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Alazizy.."Alazizy:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Alazizy.."Alazizy:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Alazizy.."Alazizy:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Alazizy.."Alazizy:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Alazizy.."Alazizy:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Alazizy.."Alazizy:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Alazizy.."Alazizy:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Alazizy..'Alazizy:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Alazizy..'Alazizy:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Alazizy..'Alazizy:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد رسائلك هنا ⇦ '..(Redis:get(Alazizy..'Alazizy:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد التعديلات هنا ⇦ '..(Redis:get(Alazizy..'Alazizy:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد جهاتك يبشا ⇦ '..(Redis:get(Alazizy.."Alazizy:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(Alazizy.."Alazizy:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⦁ ارسل الان النص
⦁ يمكنك اضافه :
...
Redis:del(Alazizy.."Alazizy:Set:Id:Groups")
...
Redis:setex(Alazizy.."Alazizy:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⦁ ارسل الان النص
⦁ يمكنك اضافه :
⦁ `#username` » اسم المستخدم
...
Redis:del(Alazizy.."Alazizy:Set:Id:Group"..msg.chat_id)
...
Redis:del(Alazizy.."Alazizy:DevelopersQ:Groups") 
...
Redis:del(Alazizy.."Alazizy:Developers:Groups") 
...
Redis:del(Alazizy.."Alazizy:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Originators:Group"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Managers:Group"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Addictive:Group"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:BanAll:Groups") 
...
Redis:del(Alazizy.."Alazizy:ktmAll:Groups") 
...
Redis:del(Alazizy.."Alazizy:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Alazizy.."Alazizy:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⦁ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Alazizy.."Alazizy:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(Alazizy.."Alazizy:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Alazizy.."Alazizy:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Alazizy.."Alazizy:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Alazizy.."Alazizy:List:Manager"..msg_chat_id)
end
...
text = "⦁ قائمه الردود ⇧⇩\nٴ•━━━ 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a ━━━━•ٴ\n"
for k,v in pairs(list) do
if Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Alazizy.."Alazizy:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Alazizy.."Alazizy:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Alazizy.."Alazizy:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Gif"..v)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:vico"..v)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:stekr"..v)     
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Text"..v)   
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Photo"..v)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Video"..v)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:File"..v)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:Audio"..v)
Redis:del(Alazizy.."Alazizy:Add:Rd:Sudo:video_note"..v)
Redis:del(Alazizy.."Alazizy:List:Rd:Sudo")
end
...
text = "\n⦁ قائمة الردود العامه ⇧⇩\nٴ•━━━ 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a ━━━━•ٴ\n"
for k,v in pairs(list) do
if Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Alazizy.."Alazizy:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Alazizy.."Alazizy:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Alazizy.."Alazizy:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Alazizy.."Alazizy:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:sadd(Alazizy.."Alazizy:cleaner"..msg_chat_id,msg_id)
end
...
local list = Redis:smembers(Alazizy.."Alazizy:cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(Alazizy.."Alazizy:cleaner"..msg_chat_id)
...
local Added_Me = Redis:get(Alazizy.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if text == 'بيرددد اي' or text == "قال اي" or text == "يرددد اي" or text == "وش يرددد" then  
...
sec = time.sec
local_time = hour..":"..min
list_zkr = Redis:smembers(Alazizy.."ChekBotAdd")

if local_time then
if local_time == "0:0" and not Redis:get(Alazizy.."0:done") then -- الساعه 12 منتصف الليل 
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."0:done", true)
for i = 1 , 23 ,1 do 
Redis:del(Alazizy..i..":done")
end
end
if local_time == "1:0" and not Redis:get(Alazizy.."1:done") then -- الساعه 1 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."1:done", true)
end
if local_time == "2:0" and not Redis:get(Alazizy.."2:done") then -- الساعه 2 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."2:done", true)
end
if local_time == "3:0" and not Redis:get(Alazizy.."3:done") then -- الساعه 3 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."3:done", true)
end
if local_time == "4:0" and not Redis:get(Alazizy.."4:done") then -- الساعه 4 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."4:done", true)
end
if local_time == "5:0" and not Redis:get(Alazizy.."5:done") then -- الساعه 5 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."5:done", true)
end
if local_time == "6:0" and not Redis:get(Alazizy.."6:done") then -- الساعه 6 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."6:done", true)
end
if local_time == "7:0" and not Redis:get(Alazizy.."7:done") then -- الساعه 7 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."7:done", true)
end
if local_time == "8:0" and not Redis:get(Alazizy.."8:done") then -- الساعه 8 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."8:done", true)
end
if local_time == "9:0" and not Redis:get(Alazizy.."9:done") then -- الساعه 9 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."8:done", true)
end
if local_time == "10:0" and not Redis:get(Alazizy.."10:done") then -- الساعه 10 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."10:done", true)
end
if local_time == "11:0" and not Redis:get(Alazizy.."11:done") then -- الساعه 11 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."11:done", true)
end
if local_time == "12:0" and not Redis:get(Alazizy.."12:done") then -- الساعه 12 ظهرا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","html",true)  
end
Redis:set(Alazizy.."12:done", true)
end
if local_time == "13:0" and not Redis:get(Alazizy.."13:done") then -- الساعه 1 مسائا
for k,v in pairs(list_zkr) do
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."13:done", true)
end
if local_time == "14:0" and not Redis:get(Alazizy.."14:done") and not Redis:get(Alazizy.."14:done") then -- الساعه 2 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)
end
Redis:set(Alazizy.."14:done", true)
end
if local_time == "15:0" and not Redis:get(Alazizy.."15:done") then -- الساعه 3 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."15:done", true)
end
if local_time == "16:0" and not Redis:get(Alazizy.."16:done") then -- الساعه 4 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."16:done", true)
end
if local_time == "17:0" and not Redis:get(Alazizy.."17:done") then -- الساعه 5 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."17:done", true)
end
if local_time == "18:0" and not Redis:get(Alazizy.."18:done") then -- الساعه 6 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."18:done", true)
end
if local_time == "19:0" and not Redis:get(Alazizy.."19:done") then -- الساعه 7 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."19:done", true)
end
if local_time == "20:0" and not Redis:get(Alazizy.."20:done") then -- الساعه 8 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."20:done", true)
end
if local_time == "21:0" and not Redis:get(Alazizy.."21:done") then -- الساعه 9 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."21:done", true)
end
if local_time == "22:0" and not Redis:get(Alazizy.."22:done") then -- الساعه 10 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."22:done", true)
end
if local_time == "23:0" and not Redis:get(Alazizy.."23:done") then -- الساعه 11 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Alazizy.."23:done", true)
end
end
...
Redis:set(Alazizy..'Alazizy:GetTexting:DevAlazizy'..msg_chat_id..':'..msg.sender.user_id,true)
...
local RinkBot = msg.Name_Controller
photo = "http://t.me/BANDA1M"
local Name = '*•⦁ ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*•⦁ [𝚆𝙴𝙻𝙲𝙾𝙼𝙴](t.me/BANDA1M) 𝚃𝙾 [𝚂𝙾𝚄𝚁𝙲𝙴](t.me/BANDA1M) 𝚃𝙴𝙰𝙼 [𝙰𝙻𝙰𝚉𝙸𝚉𝚈](t.me/BANDA1M)*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '•⦁ 𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ⦁⋆', url = "https://t.me/php_7"},{text = '•⦁ 𝙳𝙴𝚅 𝙷𝙾𝚂𝙽𝚈 ⦁⋆', url = "https://t.me/M_Hosny1"},
},
{
...
elseif text == 'العزايزي' or text == 'عزازي' or text == 'المبرمح العزايزي' or text == 'مطور السورس' or text == 'المطور العزايزي' then
photo = "https://t.me/php_7"
local Name = '⋆ معرف العزايري موجود بلاسفل'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '•⦁ 𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ⦁⋆', url = "https://t.me/php_7"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ اليك قسم الالعاب من سورس القمه ⦁',"md",false, false, false, false, reply_markup)
end
...
Redis:set(Alazizy.."zhrfa"..msg.sender.user_id,"sendzh") 
end
...
if Redis:get(Alazizy.."brgi"..msg.sender.user_id) == "sendbr" then
...
if text and text:match("^رددد (.*)$")then
local m = text:match("^رددد (.*)$")
...
if tonumber(Message_Reply.sender.user_id) == tonumber(Alazizy) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(Alazizy..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(Alazizy..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(Alazizy..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(Alazizy..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Alazizy..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(Alazizy..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(Alazizy..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(Alazizy..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Alazizy..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(Alazizy..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(Alazizy..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Alazizy..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(Alazizy..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Alazizy..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(Alazizy..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(Alazizy..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(Alazizy.."Alazizy:Sasa:MOSTAFA"..msg_chat_id) then
...
data = {
{
{text = '• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a ⋆', url = 't.me/jjjppk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id,protectionGroup,'md', false, false, false, false, reply_markup)
...
Redis:setex(Alazizy.."Alazizy:Change:Alazizy:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Alazizy.."Alazizy:Name:Bot") 
...
local NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "القمه")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/BANDA1M'}, 
},
{
...
if text == (Redis:get(Alazizy.."Alazizy:Name:Bot") or "القمه") then
local photo = LuaTele.getUserProfilePhotos(Alazizy)
local ban = LuaTele.getUser(Alazizy)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
if not msg.ControllerBot and not Redis:set(Alazizy.."Alazizy:LeftBot") then
...
x = x + 1
Redis:srem(Alazizy..'Alazizy:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(Alazizy..'Alazizy:ChekBotAdd',Get_Chat.id)
...
Redis:srem(Alazizy..'Alazizy:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set
end
...
"لو خيروك |  بين شراء منزل صغير أو استئجار فيلا كبيرة بمبلغ معرددد؟ ",
...
"لو خيروك |  بين أن تكون لديك القدرة على حفظ كل ما تسمع أو ترددده وبين القدرة على حفظ كل ما تراه أمامك؟ ",
...
"لو خيروك |  بين رددد الحقيقة والصراحة الكاملة مدة 24 ساعة أو الكذب بشكل كامل مدة 3 أيام؟ ",
...
Redis:set(Alazizy.."Alazizy:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Alazizy.."Alazizy:Game:Riddles"..msg.chat_id,name)
...
name = string.gsub(name,"الساعه","ما هو الشيئ الذي يرددد الصدق ولكنه اذا جاع كذب ؟")
...
if text == "معاني" then
if Redis:get(Alazizy.."Alazizy:Status:Games"..msg.chat_id) then
Redis:del(Alazizy.."Alazizy:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Alazizy.."Alazizy:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Alazizy.."Alazizy:Status:Games"..msg.chat_id) then
Redis:del(Alazizy.."Alazizy:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Alazizy.."Alazizy:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Alazizy.."Alazizy:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Alazizy.."Alazizy:Game:Difference"..msg.chat_id,name)
...
Redis:set(Alazizy.."Alazizy:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Alazizy.."Alazizy:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Alazizy.."Alazizy:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Alazizy.."Alazizy:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Alazizy.."Alazizy:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Alazizy..'Alazizy:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Alazizy.."Alazizy:Start:Bot") then
local CmdStart = '*\n⦁ أهلآ بك في بوت '..(Redis:get(Alazizy.."Alazizy:Name:Bot") or "القمه")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Alazizy.."Alazizy:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Alazizy.."Alazizy:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Alazizy.."Alazizy:Start:Bot") 
...
Redis:setex(Alazizy.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
⦁ ارسل اذاعتك لتثبيت في الجروبات
⦁ للخروج من الامر ارسل⋆ الغاء •
*]],"md",true)  
...
if not msg.ControllerBot then
if Redis:get(Alazizy.."Alazizy:TwaslBot") and not Redis:sismember(Alazizy.."Alazizy:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Alazizy.."Alazizy:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Alazizy.."Alazizy:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Alazizy..'Alazizy:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⦁ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Alazizy..'Alazizy:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Alazizy.."Alazizy:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Alazizy..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Alazizy.."Alazizy:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Alazizy.."Alazizy:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Alazizy.."Alazizy:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(