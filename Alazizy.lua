...
if text == "صور" or text == "صور رمزيات" then 
...
if text == "رومنسي" or text == "صور رمزيات" then 
...
https.request("https://api.telegram.org/bot"..Token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mohamedkiwa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "رومنسي" or text == "صور رمزيات" then 
Abs = math.random(439,564); 
local Text ='⋆ تم اختيار فديو حاله وتس لك' 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mohamedkiwa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
