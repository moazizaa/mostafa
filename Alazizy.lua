...
local N = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "صعيدي")
...
{
{text = '⋆  sᴏᴜʀᴄᴇ sᴀɪᴅɪ •', url='https://t.me/S_a_i_d_i'},
},
}
}
...
NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "صعيدي")
...
keyboard.inline_keyboard = {
{
{text = '•⋆ ᴍʏ ᴅᴇᴠ⋆⋆', url = "https://t.me/MY_DEV"},{text = '•⋆ ᴄʜᴀɴɴᴇʟ⋆⋆', url = "https://t.me/S_a_i_d_i"},
},
{
...
data = {
{
{text = '⋆  sᴏᴜʀᴄᴇ sᴀɪᴅɪ •', url = 't.me/jjjppk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id,protectionGroup,'md', false, false, false, false, reply_markup)
...
local NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "صعيدي")
local BotName = {
...
if text == (Redis:get(Alazizy.."Alazizy:Name:Bot") or "صعيدي") then
local photo = LuaTele.getUserProfilePhotos(Alazizy)
local ban = LuaTele.getUser(Alazizy)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
local CmdStart = '*\n⋆ أهلآ بك في بوت '..(Redis:get(Alazizy.."Alazizy:Name:Bot") or "صعيدي")..
