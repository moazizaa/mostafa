...
{
{text = '𓄼• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a •𓄹', url='https://t.me/BANDA1M'},
},
}
}
...
data = {
{
{text = '𓄼• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a •𓄹', url = 't.me/BANDA1M'}, 
},
}
}
...
local Name = '*𓄼⦁ ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼⦁ [𝚆𝙴𝙻𝙲𝙾𝙼𝙴](t.me/BANDA1M) 𝚃𝙾 [𝚂𝙾𝚄𝚁𝙲𝙴](t.me/BANDA1M) 𝚃𝙴𝙰𝙼 [𝙰𝙻𝙰𝚉𝙸𝚉𝚈](t.me/BANDA1M)*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼⦁ 𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ⦁𓄹', url = "https://t.me/php_7"},{text = '𓄼⦁ 𝙳𝙴𝚅 𝙷𝙾𝚂𝙽𝚈 ⦁𓄹', url = "https://t.me/M_Hosny1"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '𓄼⦁ 𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ⦁𓄹', url = "https://t.me/php_7"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
data = {
{
{text = '𓄼• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a •𓄹', url = 't.me/jjjppk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id,protectionGroup,'md', false, false, false, false, reply_markup)
