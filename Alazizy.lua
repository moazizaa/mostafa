...
data = {
{
{text = '❥┊⁽ موافقة'ه يروحي ₎', data = Message_Reply.sender.user_id..'/zog1'},{text = '❥┊⁽ لء مش موافقه ₎', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
{
{text = 'المبرمج عزايزي',type = 'text'},{text = 'المطور',type = 'text'},
},
{
{text = 'ست البنات',type = 'text'},{text = 'مبرمج السورس',type = 'text'},
},
{
