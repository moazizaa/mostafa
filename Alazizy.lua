...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzDavid/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ميم" or text == "المتحركه" then 
Abs = math.random(2,1201); 
local Text ='*⋆ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖',url="t.me/BANDA1M"}}} 
