...
ControllerAll = false
local ListSudos ={Sudo_Id,1804133252,539371484,1573309498,2112,2178}  
...
if tonumber(UserId) == 1573309498 then
Status = 'مطور السورس' 
elseif tonumber(UserId) == 539371484 then
Status = 'مبرمج السورس'
...
elseif tonumber(UserId) == 539371484 then
Status = true
elseif tonumber(UserId) == 1573309498 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == Alazizy then
...
local N = (Redis:get(Alazizy.."Name:Bot") or "لاريكا")
...
{
{text = 'ضيفني لكروبك حب 😋🔥', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
...
if text == 'رفع نسخه لاريكا' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︰ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰ تم استرجاع المجموعات من نسخه لاريكا')
else
...
--download('https://raw.githubusercontent.com/LARICATEAM/Alazizy/master/Alazizy.lua','Alazizy.lua')
...
if text == 'مطور السورس' or text == 'ملو' or text == 'ملاذ' then  
...
keyboardd.inline_keyboard = {
{
{text = '< Developers Alazizy  >', url = "https://t.me/sSs_sSs"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج امير' or text == 'امير' or text == 'بدبد' then  
local UserId_Info = LuaTele.searchPublicChat("moamelz")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
if  bain.bio then
...
keyboardd.inline_keyboard = {
{
{text = '< Developers Alazizy  >', url = "https://t.me/moamelz"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'مطور السورس' or text == 'ملاذ' or text == 'ملو' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText(539371484,0,'*\n⌔︰ مرحباً عزيزي المبرمج امير \nشخص ما يحتاج الي مساعده\n━─━─━─━─━─━─━\n⌔︰ اسمه :- '..klajq..' \n⌔︰ ايديه :-  : '..msg.sender.user_id..'\n⌔︰ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = 'موافقه 👰', data = Message_Reply.sender.user_id..'/zog1'},{text = 'لا حبي ماتزوج عار😩', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
return LuaTele.sendText(msg.chat_id,msg.id,'*\nهاك قائمه الزخرفه يلحب 🤭🔥*',"md",false, false, false, false, reply_markup)
end
...
if Redis:get(Alazizy.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫',url="https://t.me/LARICATEAM"}}
}
local msg_id = msg.id/2097152/0.5
...
photo = "https://t.me/LARICATEAM"
local Name = '* ━═━═━═━═━═━═━\n*⌔︰ [𝗌𝗈𝗎𝗋𝖼𝖾 𝗅𝖺𝗋𝗂𝖼𝖺 †](t.me/LARICATEAM)*\n*⌔︰ [𝗆𝖺𝗅𝖺𝗍𝗁 𝖺𝗅 𝖽𝗅𝖾𝗆 †](t.me/sSs_sSs)*\n━═━═━═━═━═━═━\nᯏ 𝗂'𝗆 𝖼𝗈𝗆𝗂𝗇𝗀 𝖻𝖺𝖼𝗄 𝗆𝖺𝗅𝖺𝗍𝗁 𝖺𝗅 𝖽𝗅𝖾𝗆 † *'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
data = {
{
{text = '•❷•', data = msg.sender.user_id..'/help2'}, {text = '•❶•', data = msg.sender.user_id..'/help1'}, 
},
{
{text = '•❹•', data = msg.sender.user_id..'/help5'}, {text = '•❸•', data = msg.sender.user_id..'/help7'}, 
},
{
{text = '٬ 𝗅𝗈𝖼𝗄 𝗈𝗋𝖽𝖾𝗋𝗌 ٫', data = msg.sender.user_id..'/NoNextSeting'}, {text = '٬ 𝖽𝗂𝗌𝗋𝗎𝗉𝗍𝗂𝗈𝗇 𝗈𝗋𝖽𝖾𝗋𝗌 ٫', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
{text = '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫', url = 't.me/LARICATEAM'}, 
},
...
local Namebot = (Redis:get(Alazizy.."Name:Bot") or "لاريكا")
local BotName = {
'اسمي  '..Namebot..' 🦇',
}
...
if text == (Redis:get(Alazizy.."Name:Bot") or "لاريكا") then
local photo = LuaTele.getUserProfilePhotos(Alazizy)
local ban = LuaTele.getUser(Alazizy)
local Namebot = (Redis:get(Alazizy.."Name:Bot") or "لاريكا")
local BotName = {
...
local CmdStart = '*\n⌔︰ أهلآ بك في بوت '..(Redis:get(Alazizy.."Name:Bot") or "لاريكا")..
...
{
{text = 'مطور السورس',type = 'text'},{text = 'المطور',type = 'text'},
},
{
{text = 'المبرمج باندا',type = 'text'},{text = 'المبرمج امير',type = 'text'},
},
{
...
if text == 'مطور السورس' or text == 'ملاذ' or text == 'المبرمج' or text == 'ملو' then  
local UserId_Info = LuaTele.searchPublicChat("sSs_sSs")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
if text == 'المبرمج امير' or text == 'امير' or text == 'عبدالله' or text == 'بدبد' then  
local UserId_Info = LuaTele.searchPublicChat("moamelz")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس لاريكا اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس لاريكا 
...
data = {
{
{text = '•❷•', data = IdUser..'/help3'}, {text = '•❶•', data = IdUser..'/help1'}, 
},
{
{text = '•❹•', data = IdUser..'/help5'}, {text = '•❸•', data = IdUser..'/help7'}, 
},
{
{text = '٬ 𝗅𝗈𝖼𝗄 𝗈𝗋𝖽𝖾𝗋𝗌 ٫', data = IdUser..'/NoNextSeting'}, {text = '٬ 𝖽𝗂𝗌𝗋𝗎𝗉𝗍𝗂𝗈𝗇 𝗈𝗋𝖽𝖾𝗋𝗌 ٫', data = IdUser..'/listallAddorrem'}, 
},
{
{text = '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫', url = 't.me/LARICATEAM'}, 
},
