...
msg.Name_Controller = 'المبرمج حسني'
msg.The_Controller = 1
...
--download('https://raw.githubusercontent.com/lolo-Alazizy/mostafa/master/Alazizy.lua','Alazizy.lua')
...
local Texting = {'⋆ ʷᵉˡᶜᵒᵐᵉ ᵗᵒ ᵗʰᵉ ᵃᶻᵃᶻʸ ˢᵒᵘʳᶜᵉ ⤌ ⤈',"⋆ ʷᵉˡᶜᵒᵐᵉ ᵗᵒ ᵗʰᵉ ᵃᶻᵃᶻʸ ˢᵒᵘʳᶜᵉ ⤌ ⤈","⋆ ʷᵉˡᶜᵒᵐᵉ ᵗᵒ ᵗʰᵉ ᵃᶻᵃᶻʸ ˢᵒᵘʳᶜᵉ ⤌ ⤈","⋆ ʷᵉˡᶜᵒᵐᵉ ᵗᵒ ᵗʰᵉ ᵃᶻᵃᶻʸ ˢᵒᵘʳᶜᵉ ⤌ ⤈","⋆ ʷᵉˡᶜᵒᵐᵉ ᵗᵒ ᵗʰᵉ ᵃᶻᵃᶻʸ ˢᵒᵘʳᶜᵉ ⤌ ⤈",}
...
if text == "صور" or text == "رمزيات" then 
...
if text == "انمي" or text == "صور انمي" then 
...
if text == "استوري قران" or text == "ارح سمعك" then 
Rrr = math.random(10,150); 
local m = "https://t.me/albukharel/"..Rrr..""
local t ='⋆ تم اختيار فديو قران لك ارح سمعك •' 
local rep = msg.id/2097152/0.5
...
if text == "حالات وتس" or text == "حالة وتس" then 
Rrr = math.random(439,564); 
local m = "https://t.me/mohamedkiwa/"..Rrr..""
local t ='⋆ تم اختيار فديو حاله وتس لك •' 
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == "تركيه" or text == "غنيلي تركي" then 
Rrr = math.random(3,200); 
local m = "https://t.me/turk_tr/"..Rrr..""
local t ='⋆ تم اختيار هذه الاغنيه التركيه لك •' 
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == "غنيلي" then
...
keyboard.inline_keyboard = {
{
{text = '⋆ القائمه الرئسيه • ', data = '/kamarasya'},{text = '⋆ ᵈᵉᵛ ʰᵒˢᶰʸ •', url = "https://t.me/M_Hosny1"},
},
{
...
elseif text == 'تانرنم' or text == 'الالعاب التسليه' or text == 'الاضافات' or text == 'الالعاب الالكترونيه' then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/BANDA1M'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⋆ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = '⋆ الالعاب التسليه •', data = msg.sender.user_id..'/stooph'}, {text = '⋆ الاضافات •', data = msg.sender.user_id..'/helma2'}, 
},
{
...
data = {
{
{text = '𝐬𝐨𝐮??𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳a²¹', url = 't.me/BANDA1M'}, 
},
}
}
...
if text == "الالعاب" or text == "التسليه" then   
if Redis:get(Alazizy.."Alazizy:Status:Games"..msg.chat_id) then 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '⋆ الالعاب الاحترافية', data = '/alabmtora'}, {text = '⋆ العاب السورس •', data = '/alabsors'}, 
},
{
{text = '⋆ الاضافات •', data = '/advat'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
⋆ مرحبا بك في قائمة الالعاب •
...
data = {
{
{text = 'لعبة1 ', data = '/Mahibes1'}, {text = '❷ ', data = '/Mahibes2'}, 
},
{
{text = '❸ ', data = '/Mahibes3'}, {text = '❹ ', data = '/Mahibes4'}, 
},
...
{
{text = '⋆ القائمه الرئسيه • ', data = '/kamarasya'},
},
}
}
local TextMahibesAgane = [[
...
local TextMahibesAgane = [[
اكتشفها بنفسك مشلازم كلحاجه اكتبها
]]
return LuaTele.editMessageText(ChatId,Msg_id,TextMahibesAgane, 'md', true, false, reply_markup)
end
