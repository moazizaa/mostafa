...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,929431022,5055146093}  
...
local N = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⋆ تم الغاء ال⋆ اذاعه بالتوجيه •للخاص","md",true)    
end 
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⋆ تم الغاء ال⋆ اذاعه بالتوجيه •للمجموعات","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Alazizy.."Alazizy:ChekBotAdd")   
...
NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")
...
keyboard.inline_keyboard = {
{
{text = '•⋆ ᴍʏ ᴅᴇᴠ⋆⋆', url = "https://t.me/MY_DEV"},{text = '•⋆ ᴄʜᴀɴɴᴇʟ⋆⋆', url = "https://t.me/BANDA1M"},
},
{
...
elseif text == 'جابوا' or text == 'جابو' or text == 'المبرمح جابوا' or text == 'مطور السورس' or text == 'المطور جابوا' then
photo = "https://t.me/J_A_B_W_A"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝑱𝑨𝑩𝑾𝑨 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '•⋆ 𝗝ٰٖ𝗔ٰٖ𝗕ٰٖ𝗪ٰٖ𝗔ٰٖ ➪🇳🇱⋆⋆', url = "https://t.me/J_A_B_W_A"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'جيكا' or text == 'المبرمج جيكا' or text == 'جيك' then
photo = "https://t.me/Dev_mostafa"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝑱𝑬𝑲𝑨 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⃟✶┊⃟𖤐.🖤⃟.𝑱𝑬𝑲𝑨⃟.🖤.𖤐⃟┊✶⃟', url = "https://t.me/Dev_mostafa"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ اليك قسم الالعاب من سورس العزايزي⋆',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = 'المـطـور الاسـاسـي', data = msg.sender.user_id..'/Newadsudos'},
},
{
{text = 'اسـم البــوت', data = msg.sender.user_id..'/NamesBot'},
},
{
...
local NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")
local BotName = {
'اسمي القميل '..NamesBot..' يروحي..🥺♥️',
'اسمي الكيوت '..NamesBot..' يحياتي..🙈💞',
'اسمي '..NamesBot..' يحبيبي..🌚💘',
'اندهني ب اسمي '..NamesBot..' 🥺💔',
'انا اسمي '..NamesBot..' يعمري..🥺❤️',
}
...
if text == (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي") then
local photo = LuaTele.getUserProfilePhotos(Alazizy)
local ban = LuaTele.getUser(Alazizy)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
local NamesBot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")
local BotName = {
'⋆ يوه '..NamesBot..' زهق منك😒',
'⋆ نعم ياعيون '..NamesBot..' 😻💓',
'⋆ عايز اي من '..NamesBot..' 🙄💛',
'⋆ اي يا قلب '..NamesBot..' 💋😉', 
'⋆ اي ياروحي انا '..NamesBot..'😸🦋',
'نعم 🍒🤍'
}
NamesBots = BotName[math.random(#BotName)]
local first_n = ban.first_name
...
local CmdStart = '\n⋆ أهلآ بك في بوت '..(Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")..
