...
if Redis:hget(Alazizyح.."Alazizy:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
...
data = {
{
{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳??𝐳a²¹', url = 't.me/BANDA1M'}, 
},
}
}
...
local Namebot = (Redis:get(Alazizy.."Alazizy:Name:Bot") or "العزايزي")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = Namebots, url = 't.me/BANDA1M'}, 
},
{
