...
ControllerAll = false
local ListSudos ={Sudo_Id,1414888743,1554085475,1183747742,5076237918,1761050341}  
...
if tonumber(msg.sender.user_id) == 1414888743 then
...
data = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = 't.me/jjjppk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id,protectionGroup,'md', false, false, false, false, reply_markup)
