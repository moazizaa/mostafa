...
--download('https://raw.githubusercontent.com/JABWA-Alazizy/JEKA/master/Alazizy.lua','Alazizy.lua')
...
Redis:set(Alazizy.."Alazizy:Sasa:Jeka"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Alazizy.."Alazizy:Sasa:Jeka"..msg_chat_id) 
...
if not Redis:get(Alazizy.."Alazizy:Sasa:Jeka"..msg_chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Alazizy.."Alazizy:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Alazizy.."Alazizy:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
